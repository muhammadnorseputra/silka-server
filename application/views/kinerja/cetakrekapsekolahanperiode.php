...
{     
	...
	function Content($data)
	{
	    ...
	    $golru = $mpeg->mpegawai->getnamagolru($k->fid_golru);
            $this->MULTICELL(50,5,$mpeg->mpegawai->getnamapangkat($k->fid_golru).' ('.$golru.')','','L',1);
            $this->setXY($x+60,$y);
            $this->MULTICELL(80,4,$mpeg->mpegawai->namajabnip($k->nip),'','L',1);
            $this->setXY($x+60,$y+5);
            $this->MULTICELL(80,4,$mun->munker->getnamaunker($k->fid_unker),'','L',1);
	    ...
	    // UNTUK YANG BELUM S1 / MASIH GOLONGAN II, DIBERIKAN 75%
            ...
            $this->setXY($x+240,$y+8);
            $this->MULTICELL(8,4,$ketthp,'','L',1);
	
	    $this->setFont('arial','',9);
            $this->setXY($x+248,$y+8);
            $this->MULTICELL(22,4,number_format($k->jml_tpp_murni,0,",","."),'','R',1);
            $this->setXY($x+240,$y+12);
	...
	$qrcode = $mkin->mkinerja->getqrcodeperpengantar($k->fid_pengantar, $k->tahun, $k->bulan);
        ...
        $this->setXY($x+240,$y+40); $this->MULTICELL(55,4,"KEPALA DINAS PENDIDIKAN",'','C',1);
