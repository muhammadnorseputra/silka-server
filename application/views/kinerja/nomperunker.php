  ...
  <table class="table table-bordered table-hover"  style="font-size: 11px;">
	...
	<?php
	  ...
	  $keltugasjft = $this->mpegawai->getkeltugas_jft_nip($nip);
          ...
          if (($jenisjab == "STRUKTURAL") OR ($jenisjab == "FUNGSIONAL UMUM") OR (($jnsjab == "FUNGSIONAL TERTENTU") OR ($keltugasjft == "TEKNIS"))  OR (($jnsjab == "FUNGSIONAL TERTENTU") OR ($keltugasjft == "PENYULUH"))) {
          	echo "<td class='$warna'>";
          	if ($nilaiskp > 100) {
            		$nilaiskp100k++; 
