  ...
  <table class="table table-bordered table-hover"  style="font-size: 11px;">
      ...
      foreach($usul_tpp as $v):
        ...
        if (($nilaiskp != 0) || ($nilaiskp != null)) {
          ...
          echo "<td>NIPPPK. ".$nip."<br/>".$nama."<br/>".$pangkat." (".$golru.")";
...
<table class='table table-condensed'>
    ...
    <?php
      $tottppkotor = $this->mkinerja_pppk->tottppkotor_perunkerperiode($idunker, $thn, $bln);
      $tottambahan = $this->mkinerja_pppk->tottambahan_perunkerperiode($idunker, $thn, $bln);
      $tottppmurni = $this->mkinerja_pppk->tottppmurni_perunkerperiode($idunker, $thn, $bln);
      $totpajak = $this->mkinerja_pppk->totpajak_perunkerperiode($idunker, $thn, $bln);
      $tottppditerima = $this->mkinerja_pppk->tottppditerima_perunkerperiode($idunker, $thn, $bln);
    ?>
