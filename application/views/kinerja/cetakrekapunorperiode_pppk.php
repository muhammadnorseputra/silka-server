...
{     
	...
	function Content($data)
	{
        ...
        $this->MULTICELL(30,4,'- BPJS 2%','LR','R',1);
        ...
        $ratakinerja = $mkin->mkinerja_pppk->getratakinerja($k->fid_unker, $k->tahun, $k->bulan);
        $rataabsensi = $mkin->mkinerja_pppk->getrataabsensi($k->fid_unker, $k->tahun, $k->bulan);
        ...
        $tottppkotor = $mkin->mkinerja_pppk->tottppkotor_perunkerperiode($k->fid_unker, $k->tahun, $k->bulan);
        $tottambahan = $mkin->mkinerja_pppk->tottambahan_perunkerperiode($k->fid_unker, $k->tahun, $k->bulan);
        
        $tottppmurni = $mkin->mkinerja_pppk->tottppmurni_perunkerperiode($k->fid_unker, $k->tahun, $k->bulan);
        $totpajak = $mkin->mkinerja_pppk->totpajak_perunkerperiode($k->fid_unker, $k->tahun, $k->bulan);
        $tottppditerima = $mkin->mkinerja_pppk->tottppditerima_perunkerperiode($k->fid_unker, $k->tahun, $k->bulan);
