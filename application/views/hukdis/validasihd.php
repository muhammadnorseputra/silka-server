<center>  
  <div class="panel panel-info" style="width: 80%">
    <div class="panel-body">
      <form method='POST' action='../hukdis/tampilvalidasi'>          
      <p align="right">
          ...
          <tr>
              ...
              <table class='table table-condensed'>
                ...
                <tr class='warning'>
                  ...
                  <tr>
                    ...
                    <td readonly width="1%">:</td>
                    <td><?php echo $this->mhukdis->getjnshukdis($v['fid_jenis_hukdis'])."<br/>TINGKAT. <b>".$this->mhukdis->gettingkathukdis($v['fid_jenis_hukdis'])."</b>";?></td>
                  </tr>
                  <tr>
		    ...
		    <td>
                ...
                <tr class='info'>
                  ...
                  <td align='center'>
                      <form method='POST' action='../hukdis/validasihd_aksi'>                    
                      <?php          
                      if (($this->session->userdata('level') == "ADMIN") OR ($this->session->userdata('nip') == "198705242010012015")) { 
                        ...
                        <button type='submit' class="btn btn-warning">
                          <span class="glyphicon glyphicon-tags" aria-hidden="true"></span><br/>&nbspValidasi</button>
