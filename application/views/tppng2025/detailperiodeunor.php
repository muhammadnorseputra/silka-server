...
<center>
  ...
  <table class='table table-condensed'>
	...
	//if (($statuspengantar == "SKPD") AND (($this->session->userdata('nip') == "198104072009041002") OR ($this->session->userdata('nip') == "197708232006042022"))) {
	  ...
	  if (($tahunperiode == '2025') AND ($bulanperiode == '14')) { // Tambah Data THR
	    ?>
  ...
  $jnsasn = $this->mtppng2025->get_jnsasn($idpengantar);
  ?>  
  ...
  ?>
  <div class='panel-heading' align='left' style='background-color : <?php echo $color;?>;'>
  <b>DETAIL TPP ::: <?php echo $this->munker->getnamaunker($idunor); ?></b><br />
  PERIODE <?php echo strtoupper(bulan($this->mtppng2025->get_bulanperiode($idperiode)))." ".$this->mtppng2025->get_tahunperiode($idperiode); ?>
  <br/>
  <?php
  if ($jnsasn == "PNS") {
    echo "<span class='label label-info'>JENIS ASN : ".$this->mtppng2025->get_jnsasn($idpengantar)."</span>";
  } else if ($jnsasn == "PPPK") {
    echo "<span class='label label-info'>JENIS ASN : ".$this->mtppng2025->get_jnsasn($idpengantar)."</span>";
  }
   
  echo " <span class='label label-primary'>STATUS : ".$statuspengantar."</span>";
  ?>
  </div>
  <!-- untuk scrollbar -->
  ...
  <table class="table table table-condensed table-hover"  style='font-size: 11px;'>
	...
	<td align='center' width='150' rowspan='2'><b>TAMBAHAN<br/>PPh21<br/>BPJS 4%</b></td>
      ...
      <tr style='background-color : <?php echo $color1;?>; font-size: 9px; font-style: italic;'>
	...
	<td align='right' style='padding-left:10px;'>
	  <?php
        ...
        <td align='right' style='padding-left:10px;'>
          <?php
	    $katpajak = $this->mtppng2025->get_kategori_pp582023($v['jns_ptkp']);
            $hasil_bruto = $v['gaji_bruto'] + $v['real_total'];
            $tarifpajak = $this->mtppng2025->get_tarifpph21_pp582023($katpajak, $hasil_bruto);
	  ...
	  ?>
        ...
        <td align='center'>
          <?php
            $status = $this->mtppng2025->get_statustppng($v['fid_status']);
            if ($status == "INPUT") {
        ...
        <td align='center' width='40px'>
          ...
          $statuspengantar = $this->mtppng2025->get_statuspengantar($v['fid_pengantar']);
          if (($status == "INPUT") AND ($statuspengantar == "SKPD") AND ($v['bulan'] != "14") AND ($v['bulan'] != "15")) {
            echo "<form method='POST' action='../tppng2025/valid_tppng'>";
            ...
            echo "<form method='POST' action='../tppng2025/invalid_tppng'>";
            echo "<input type='hidden' name='id' id='id' value='$v[id]'>";
            echo "<input type='hidden' name='id_pengantar' id='id_pengantar' value='$idpengantar'>";
            echo "<input type='hidden' name='id_periode' id='id_periode' value='$idperiode'>";
        ...
        <td align='center' width='40px'>
		  ...
		  $hasil_bruto = $v['gaji_bruto'] + $v['real_total'];
          	  ...
          	  if ($jnsasn == "PNS") {
                	$pph_bayar = $this->mtppng2025->hitungpph($v['nip'], $v['tahun'], $v['bulan'], $v['real_total']);
          	  } else if ($jnsasn == "PPPK") {
			$pph_bayar = $this->mtppng2025->hitungpph_pppk($v['nip'], $v['tahun'], $v['bulan'], $v['real_total']);
          	  }

          	  $katpajak = $this->mtppng2025->get_kategori_pp582023($v['jns_ptkp']);
          	  $ptkpgaji = $this->mtppng2025->get_ptkpgaji_pns($v['nip'], $v['tahun'], $v['bulan']);
		  ...
		  echo "<div class='row'>";
	          echo "<div class='col-md-4'>
                  	  <div class='well well-sm' style='font-size: 10px;'>
                    	     ...
                    	     <div class='row'>
                      		...
                      		<div class='col-md-6' align='right' style='margin-bottom:5px;'>".$this->mtppng2025->get_tarifpph21_pp582023($katpajak, $hasil_bruto)." %</div>
                    	     </div>
                    	     <div class='row'>
		    ...
		    $bpjs_gaji = $this->mtppng2025->get_bpjsgaji($v['nip'], $v['tahun'], $v['bulan']); 
	  ...
	  <!-- End Modal Detail -->
        ...
        <td align='center' width='40px'>
          ...
          if (($status == "INPUT") AND ($v['bulan'] != "14") AND ($v['bulan'] != "15")) {
            echo "<form method='POST' action='../tppng2025/hapustppng'>";
  ...
  <div class='row'>
    <div class='col-md-3' align='left'>
      <blockquote style='font-size: 11px;'>
        <div class='row'>
          ...
          <div class='col-md-6' align='right'><?php echo $this->mtppng2025->get_jmlperpengantar($idpengantar); ?></div>
        </div>
        <div class='row'>
          <div class='col-md-6'>Rata-rata Kinerja</div>
          <div class='col-md-6' align='right'><?php echo round($this->mtppng2025->getratakinerja_perbulan($idpengantar),2); ?></div>
        </div>
        <div class='row'>
          <div class='col-md-6'>Rata-rata Absensi</div>
          <div class='col-md-6' align='right'><?php echo round($this->mtppng2025->getrataabsensi_perbulan($idpengantar),2); ?></div>
        </div>                    
      </blockquote>
    </div>
    <div class='col-md-3' align='left'>
      <blockquote style='font-size: 11px;'>
        <div class='row'>
          ...
          <div class='col-md-5' align='right'><?php echo "Rp. ".number_format($this->mtppng2025->gettotalbk_perbulan($idpengantar),0,",","."); ?></div>
        </div>
        <div class='row'>
          <div class='col-md-7'>Total Prestasi Kerja</div>
          <div class='col-md-5' align='right'><?php echo "Rp. ".number_format($this->mtppng2025->gettotalpk_perbulan($idpengantar),0,",","."); ?></div>
        </div>
        <div class='row'>
          <div class='col-md-7'>Total Kondisi Kerja</div>
          <div class='col-md-5' align='right'><?php echo "Rp. ".number_format($this->mtppng2025->gettotalkk_perbulan($idpengantar),0,",","."); ?></div>
        </div>
        <div class='row'>
          <div class='col-md-7'>Total Kelangkaan Profesi</div>
          <div class='col-md-5' align='right'><?php echo "Rp. ".number_format($this->mtppng2025->gettotalkp_perbulan($idpengantar),0,",","."); ?></div>
        </div>
        <div class='row text text-success'>
          <div class='col-md-7'><b>Total Realisasi</b></div>
          <div class='col-md-5' align='right'><b><?php echo "Rp. ".number_format($this->mtppng2025->gettotalreal_perbulan($idpengantar),0,",","."); ?></b></div>
        </div>
      </blockquote>
    </div>
    <div class='col-md-3' align='left'>
      <blockquote style='font-size: 11px;'>
        <div class='row'>
          ...
          <div class='col-md-6' align='right'><?php echo "Rp. ".number_format($this->mtppng2025->gettotalpph_perbulan($idpengantar),0,",","."); ?></div>
        </div>
        <div class='row'>
          <div class='col-md-6'>Total Tamb. BPJS</div>
          <div class='col-md-6' align='right'><?php echo "Rp. ".number_format($this->mtppng2025->gettotalbpjs_perbulan($idpengantar),0,",","."); ?></div>
        </div>
	<?php
	$totaltamb = $this->mtppng2025->gettotalpph_perbulan($idpengantar) + $this->mtppng2025->gettotalbpjs_perbulan($idpengantar);
	?>
        <div class='row text text-success'>
    ...
    <div class='col-md-3' align='left'>
      <blockquote style='font-size: 11px;'>
        ...
        <div class='row'>
          ...
          <div class='col-md-6' align='right'><?php echo "Rp. ".number_format($this->mtppng2025->gettotaliwp_perbulan($idpengantar),0,",","."); ?></div>
        </div>
        <div class='row'>
	...
	<?php
	$totpoto = $this->mtppng2025->gettotalpph_perbulan($idpengantar) + $this->mtppng2025->gettotaliwp_perbulan($idpengantar) + $this->mtppng2025->gettotalbpjs_perbulan($idpengantar); 
	?>
	...
	<br />
        <div class='row text text-primary'>
          ...
          <div class='col-md-6' align='right'><b><?php echo "Rp. ".number_format($this->mtppng2025->gettotalthp_perbulan($idpengantar),0,",","."); ?></b></div>
        </div>
      </blockquote>
    </div>
  </div>
...
<div align='right'>
<?php
  $jml = $this->mtppng2025->get_jmlperpengantar($idpengantar);
  $uda = $this->session->userdata('nip');
  if ($jml != 0) {
    $cekstatusinput = $this->mtppng2025->cek_adastatusinput($idpengantar);
    $statuspengantar = $this->mtppng2025->get_statuspengantar($idpengantar);

    // Cek apakah masih ada yg belum Sync dengan SiGapok
    $cekstatussyncgaji = $this->mtppng2025->cek_adabelumsyncgaji($idpengantar);

    if (($cekstatusinput == 0) AND ($statuspengantar == "SKPD")) {
      echo "<form method='POST' action='../tppng2025/valid_pengantar'>";
      echo "<input type='hidden' name='id_pengantar' id='id_pengantar' value='$idpengantar'>";
      echo "<input type='hidden' name='id_periode' id='id_periode' value='$idperiode'>";
      ?>
      ...
      echo "<form method='POST' action='../tppng2025/approve_pengantar'>";
      echo "<input type='hidden' name='id_pengantar' id='id_pengantar' value='$idpengantar'>";
      echo "<input type='hidden' name='id_periode' id='id_periode' value='$idperiode'>";
      ?>
      <button type="submit" class="btn btn-primary btn-outline btn-xl ">
	...
	<button type='button' class='btn btn-primary btn-outline btn-xl' data-toggle='modal' data-target='#spesimen'>
              <span class='glyphicon glyphicon-print' aria-hidden='true'></span><br/>Spesimen dan Cetak TPP THR 2025
        </button>
	-->
      <?php
      } else {
...
<div class="modal fade" id="uploadsp2d" tabindex="-1" role="dialog" aria-labelledby="uploadsp2dLabel" aria-hidden="true">
  ...
  <form method='POST' name='formtandaterima' action='../tppng2025/kirim_tandaterima' enctype="multipart/form-data">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div style="display:flex; justify-content: space-between; align-items: center; background: pink; border: 1px dashed #ededed; padding: 8px; border-radius: 8px">
          ...
          <div>
            <a href="<?= base_url('filetppng2025/'.$v['berkas'].'.pdf') ?>" target="_blank" class="btn btn-sm btn-success"><span class='glyphicon glyphicon-download' aria-hidden='true'></span> Download</a>
          </div>
        </div>
        <hr>
        <?php endif; ?>
...
<!-- Modal Spesimen -->
            ...
            <div class="modal-dialog modal-xs modal-dialog-centered">
              <div class="modal-content">
                <div class='modal-header'>
                  ...
                  <?php
                    $id_unker_pengantar = $this->mtppng2025->get_idunker($idpengantar);
		  ...
		  ?>
                     <form method='POST' name='formspesimen' action='../tppng2025/cetak_tandaterimathr' target='_blank'>
                  <?php
		  } else {
		  ?>
		     <form method='POST' name='formspesimen' action='../tppng2025/cetak_tandaterima' target='_blank'>	
		  <?php
		  }
		  ?>
		  <input type='hidden' name='idpengantar' id='idpengantar' value='<?php echo $v['fid_pengantar']; ?>' />
...
<!--<div id="tampiltambah" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="padding:10px;overflow:auto;width:100%;height:90%;">-->
  <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document" style="padding:10px;width:60%;height:auto;">
    ...
    <div class="modal-content">
      <?php
        $jnsasn = $this->mtppng2025->get_jnsasn($idpengantar);
	$tahun = $this->mtppng2025->get_tahunperiode($idperiode);
        $bulan = $this->mtppng2025->get_bulanperiode($idperiode);
      ?>
      <!-- heading modal -->
      <?php
      // Untuk Header Modal
      if ($jnsasn == "PNS") {
        ...
        echo "<div class='modal-header' style='background-color : #778877'>";
      ...
      ?>
              ...
              <div class="modal-body" align="left"">   
                <form method='POST' name='formkalk' style='padding-top:8px' action='../tppng2025/tmbkalk_aksi'>
                  <input type='text' name='idpengantar' id='idpengantar' value='<?php echo $idpengantar; ?>'>
                  <input type='text' name='idperiode' id='idperiode' value='<?php echo $idperiode; ?>'>
                  <input type='text' name='jnsasn' id='jnsasn' value='<?php echo $jnsasn; ?>'>
                  <div class='row'>                                                
                    <div class='col-md-12'>
                      <div class="form-group input-group">    
			...
			//if ($this->session->userdata('nip') == "198104072009041002") {
			  ...
			  echo "<option value='' selected>".$ident." - NAMA</option>";
                          if ($pegunker) {
                            ...
                            {
				$telahusul = $this->mtppng2025->cektelahusul($pu['nip'], $tahunperiode, $bulanperiode);
				if ($telahusul == '0') {
		...
		<!-- Non Aktifkan Pilihan Jabatan Definitif
		...
		<!-- End Non Aktif Jabatan Definitif -->
                  ...
                  <div class='row'>
                    <div class='col-md-12' align="center">
                      <button type="button" class="btn btn-default btn-default btn-lg" 
			onclick="showDataKalkulasi(formkalk.nip.value, formkalk.idperiode.value, formkalk.idpengantar.value, 
				...
				style='background-color : <?php echo $color1;?>; width: 100%' >
                        <span class="glyphicon glyphicon-arrow-down" aria-hidden="true"></span> Kalkulasi TPP
                      </button>
                    </div>
                  </div>
                  <div class='row'>  
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document" style="padding:10px;width:60%;height:auto;">
    ...
    <div class="modal-content">
      ...
      ?>
              <!-- body modal-->
              <div class="modal-body" align="left"">
                <form method='POST' name='formkalkthr' style='padding-top:8px' action='../tppng2025/tmbkalkthr_aksi'>
                  <input type='hidden' name='idpengantar' id='idpengantar' value='<?php echo $idpengantar; ?>'>
                  <input type='hidden' name='idperiode' id='idperiode' value='<?php echo $idperiode; ?>'>
                  <div class='row'>
		    <div class='col-md-12'>
                        <div class="alert alert-info" role="alert"><strong>PERHATIAN !</strong><br/>
			- TPP THR Tahun 2025 berdasarkan status kedudukan dan posisi jabatan ASN sesuai TPP  Februari 2025<br/>
			- ASN yang berhak TPP THR Tahun 2025 adalah ASN yang menerima TPP Februari 2025 (dibayarkan Maret 2025)<br/>
			- ASN PPPK formasi tahun 2023 (SPMT 1 Maret 2025) tidak berhak menerima TPP THR Tahun 2025
			</div>
                    </div>	
                    <div class='col-md-12'>
                      <div class="form-group input-group">
                    ...
                    <div class='col-md-4' align="right">
                      <div class="form-group input-group">
                        <?php
                          if ($jnsasn == "PNS") {
                            $ident = "NIP";
                            $pegunker = $this->mtppng2025->pegperunker($idunor)->result_array();
                            echo "<span class='input-group-addon' style='font-size: 12px;'>Pilih PNS</span>";
                          } else if ($jnsasn == "PPPK") {
                            $pegunker = $this->mtppng2025->pppkperunker($idunor)->result_array();
                            $ident = "NIPPPK";
                            echo "<span class='input-group-addon' style='font-size: 12px;'>Pilih PPPK</span>";
                          }
                        ?>
                  ...
                  <span class='text text-info'>Pilih Jabatan Definitif yang akan digunakan untuk perhitungan TPP THR 2025</span>, 
		  <span class='text text-danger'>WAJIB sama dengan jabatan pada TPP Februari 2025</span>
                  <div class='row'>
                    <div class='col-md-12' align="right">
                      <div class="form-group input-group">
                        <span class="input-group-addon" style="font-size: 12px;">Jabatan Definitif</span>
                  ...
                  <div class='row'>
                    <div class='col-md-12' align="center">
                      <button type="button" class="btn btn-success btn-outline btn-lg"
                        ...
                        <span class="glyphicon glyphicon-search" aria-hidden="true"></span> Kalkulasi TPP THR 2025
                      </button>
                    </div>
                  </div>
                  <div class='row'>
...
<div id="updatestatus<?php echo $idpengantar; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog modal-xl" role="document">
	...
	echo "<h5 class='modal-title text text-muted'>Jenis ASN : ".$this->mtppng2025->get_jnsasn($idpengantar)."</h5>";
      ?>
      </div> <!-- End Header -->
      <div class="modal-body" align="left">
        <form method='POST' name='formupdatestatus' style='padding-top:8px' action='../tppng2025/updatestatusperorangan_aksi'>
          <input type='hidden' name='idpengantar' id='idpengantar' value='<?php echo $idpengantar; ?>'>
          <input type='hidden' name='idperiode' id='idperiode' value='<?php echo $idperiode; ?>'>
	  <input type='hidden' name='idunor' id='idunor' value='<?php echo $idunor; ?>'>
          <div class='row'>
		    ...
		    $stat = $this->mtppng2025->statustppng()->result_array();
                    foreach($stat as $s)
                    {
