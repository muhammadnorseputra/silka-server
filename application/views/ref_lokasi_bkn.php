...
<!-- Default panel contents -->
  <center>
    <div class="panel panel-info" style="padding:3px;overflow:auto;width:98%;height:620px;">
      <div class='panel-heading' align='left'><span class="glyphicon glyphicon-dashboard" aria-hidden="true"></span>
        <b>DATA REFERENSI KABUPATEN / KOTA BKN</b>
      </div>
  ...
  <center>
    <form method='POST' name='formreflok' style='margin-top: 30px;'>
	<div class="row" style="padding:3px;width:70%;height:auto;">
		<div class="col-md-2 text-center"></div>
		<div class="col-md-7 text-center">
			<input class='form-control' placeholder='Ketik Nama Kabupaten / Kota' type='text' name='nmlok' id='nmlok' maxlength='50' value=''>
		</div>
		<div class="col-md-2 text-left">
			<button type="button" class="btn btn-info" onClick="showData(formreflok.nmlok.value)">
            		<span class="fa fa-search" aria-hidden="true"></span> Cari Kabupaten / Kota
          </button>
		</div>
	</div>
      </form>
...
<script>
var options = {
	url: "<?= base_url('home/show_autocomplete/lokasi') ?>",
	getValue: "nama",
	listLocation: "items",
	ajaxSettings: {
	    dataType: "json",
    ...
    onChooseEvent: function() {
      var row = $("#nmlok").getSelectedItemData();
			showData(row.nama)
		}
	},
...
$("#nmlok").easyAutocomplete(options);
</script>
