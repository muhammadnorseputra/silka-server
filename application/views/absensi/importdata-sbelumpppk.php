...
<script src="<?php echo base_url('js/jquery.min.js'); ?>"></script>
        ...
        <div class="col-sm-6 col-md-5">
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              <br/><small class='text-danger'>
                Pail nang kawa di-import harus dalam format .xlsx<br/>
                CEK BANAR BUJUR-BUJUR DULU SABALUM DI-IMPORT,<br/>
                DATA ABSENSI NANG UDAH DI-IMPORT KADA KAWA DIHAPUS LAGI, UDAH KAH ???
              </small>
              </div>
              <div class="row">
		  ...
		  <div class="col-sm-6 col-md-8" align="right">
                  ...
                  <div class="col-sm-6 col-md-4" align="left">
                    ...
                    <button type="submit" value="Preview" name="preview" class="btn btn-sm btn-success">
  ...
  if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
    ...
    <tr class='info'>
      ...
      <td align='center' width='50'>Periode</td>
      <td align='center' width='50'>Jumlah HK</td>
      <td align='center' width='40'>Hadir</td>
      <td align='center' width='40'>Izin</td>
      <td align='center' width='40'>Sakit</td>
      <td align='center' width='40'class='warning'>Terlambat</td>
      <td align='center' width='40'class='warning'>Pulang Cepat</td>
      <td align='center' width='40'class='danger'>TK</td>
      <td align='center' width='40'>Cuti</td>
      <td align='center' width='50'>Tugas Dinas</td>
      <td align='center' width='50'>Tugas Belajar</td>
      <td align='center' width='50' class='danger'><b>Total Pengurang</b></td>
      <td align='center' width='50' class='danger'><b>REALISASI</b></td>
    ...
    foreach($sheet as $row){ 
      ...
      if($numrow > 1){
        ...
        //$sakit_td = ( ! empty($sakit))? "" : " style='background: #E07171;'";
        //$tk_td = ( ! empty($tk))? "" : " style='background: #E07171;'";
        //$cuti_td = ( ! empty($cuti))? "" : " style='background: #E07171;'";
        //$tudin_td = ( ! empty($tudin))? "" : " style='background: #E07171;'";
        //$tubel_td = ( ! empty($tubel))? "" : " style='background: #E07171;'";
	...
	*/
	...
	if ($nip == "" or $bulan == "" or $tahun == "" or $jml_hari == "") {
        ...
        echo "<td align='left'".$nip_td."><small>".$this->mpegawai->getnama($nip)." | NIP. ".$nip."</small><br/>";        
        echo $this->munker->getnamaunker($this->mpegawai->getfidunker($nip))."</small></td>";
        echo "<td".$periode_td.">".bulan($bulan)."<br/>".$tahun."</td>";
        echo "<td".$jml_hari_td."><b>".$jml_hari."</b></td>";        
        echo "<td".$hadir_td."><b>".$hadir."</b></td>";
        echo "<td>".$izin."</td>";
        echo "<td>".$sakit."</td>";
        if ($terlambat != 0) {
          echo "<td class='warning' style='color: orange'><b>".$terlambat."</b></td>";
        } else {
          echo "<td class='warning'><b>".$terlambat."</b></td>";
        } 

        if ($pulang_cepat != 0) {
          echo "<td class='warning' style='color: orange'><b>".$pulang_cepat."</b></td>";
        } else {
          echo "<td class='warning'><b>".$pulang_cepat."</b></td>";
        }

        if ($tk != 0) {
          echo "<td class='danger' style='color: red'><b>".$tk."</b></td>";
        } else {
          echo "<td class='danger'><b>".$tk."</b></td>";
        }

        echo "<td>".$cuti."</td>";
        echo "<td>".$tudin."</td>";
        echo "<td>".$tubel."</td>";
        $totpengurang = (2*$terlambat) + (2*$pulang_cepat) + (5*$tk);
        if ($totpengurang > 100) {
          $realisasi = 0; 
        } else {
