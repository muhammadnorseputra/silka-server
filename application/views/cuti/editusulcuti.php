...
<center>  
  <div class="panel panel-default" style="width: 80%">
    <div class="panel-body">
      ...
      <form method='POST' name='formeditusulcuti' action='../cuti/editusul_aksi'>
              ...
              <table class="table table-condensed">
                ...
                <tr>
                  <td colspan='2' align='right'>
                    <textarea id="catatan_pej_kepeg" name="catatan_pej_kepeg" rows="7" cols="43" required><?php echo $v['catatan_pej_kepeg']; ?></textarea>
                  </td>
                  <td colspan='2' align='center'>
                    <textarea id="catatan_atasan" name="catatan_atasan" rows="7" cols="43"><?php echo $v['catatan_atasan']; ?></textarea>
                  </td>
                  <td colspan='2' align='left'>
                    <textarea id="keputusan_pej" name="keputusan_pej" rows="7" cols="43"><?php echo $v['keputusan_pej']; ?></textarea>
                  </td>
                </tr>
              </table>   
            </td>
