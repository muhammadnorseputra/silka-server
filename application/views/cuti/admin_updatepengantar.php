...
<center>  
  <div class="panel panel-danger" style="width:60%; background-color:Beige;">
    <div class="panel-body">
      <?php
        echo "<form method='POST' action='../cuti/admin_tampilupdatepengantar'>";          
      ...
      <form method='POST' action='../cuti/admin_updatepengantar_aksi'>
          ...
          <tr>
            <td align='center'>                           
              <table class='table table-condensed'>
                <tr>
                  <td align='right' width='150'>No. Pengantar :</td>
                ...
                <tr>
                  ...
                  <td>
                    <select name="id_status" id="id_status" required />
                      ...
                      {
                        if ($v['fid_status']==$sp['id_statuspengantarcuti']) {
                          echo "<option value='".$sp['id_statuspengantarcuti']."' selected>".$sp['nama_statuspengantarcuti']."</option>";
                        } else {
                          echo "<option value='".$sp['id_statuspengantarcuti']."'>".$sp['nama_statuspengantarcuti']."</option>";
                        }                        
                      }
                      ?>
                    </select>                         
