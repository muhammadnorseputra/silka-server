...
<center>  
  <div class="panel panel-default" style="width: 80%">
    <div class="panel-body">
      <?php
        echo "<form method='POST' action='../cuti/tampilinbox'>";          
      ...
      <form method='POST' name='formeditusulcuti' action='../cuti/updateusulbtl_aksi'>
          ...
          <tr>
            <td align='center'>                           
              <table class="table table-condensed">
                ...
                <td colspan='4'><?php echo '<b>'.$this->mcuti->getstatuscuti($v['fid_status']).'</b><br/>'.$v['alasan']; ?>
                </td>
              </table>   
            </td>
          </tr>
