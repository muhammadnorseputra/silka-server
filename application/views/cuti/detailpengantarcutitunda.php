<!-- Default panel contents -->
  ...
  <div class="panel-heading panel-info" align="left">
  <b>CUTI TUNDA<br />Pengantar Nomor : <?php echo $nopengantar; ?></b><br />
  <?php echo "Jumlah Data : ", $jmldata, " Usul"; ?>
  </div>
  <!-- untuk scrollbar -->
  <div style="padding:3px;overflow:auto;width:99%;height:290px;border:1px solid white;background:#FFFFFF" >
  <table class="table table-condensed table-hover">
      <tr class='info'>
        <td align='center'><b>No</b></td>
        <td align='center' width='300'><b>NIP | Nama</b></td>
        <td align='center'><b>Jabatan</b></td>
        <td align='center' width='120'><b>Tahun</b></td>
        <td align='center' width='120'><b>Jml Hari</b></td>
      ...
      <tr>
        ...
        <td align='center'><?php echo $v['jml_hari']; ?></td>
        ...
        <td align='center'>
          <?php
          if ($this->mcuti->getstatuspengantar_byidpengantar($idpengantar) == 'SKPD') {
            echo "<form method='POST' action='../cuti/hapus_tunda'>";          
            echo "<input type='hidden' name='nip' id='nip' value='$v[nip]'>";
      ...
      ?>
          ...
          <?php
          if ($this->mcuti->getjmldetailpengantar($idpengantar, 'CUTI TUNDA') == 0) {
          ...
          <?php
            ...
            echo "<form method='POST' action='../cuti/kirimtunda_kebkppd'>";          
