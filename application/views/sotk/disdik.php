...
{     
  ...
  function Content($data)
  {
      ...
      // menggunakan ID jabatan, beda dengan yang lain yang menggunakan nama jabatan, karena terdapat nama seksi yang sama pada bidang yang berbeda
      $unker = "DINAS PENDIDIKAN";
      $j1 = 1401; //"KEPALA";
      $j1t = "DINAS PENDIDIKAN";

      $j2 = 1402; // "SEKRETARIS";
      $j2t = "SEKRETARIAT";
      $j21 = 1403; // "KEPALA SUB BAGIAN PERENCANAAN DAN PELAPORAN";
      $j21t = "SUB BAGIAN PERENCANAAN DAN PELAPORAN";
      $j22 = 1404; // "KEPALA SUB BAGIAN KEUANGAN";
      $j22t = "SUB BAGIAN KEUANGAN";
      $j23 = 1405; // "KEPALA SUB BAGIAN UMUM DAN KEPEGAWAIAN";
      $j23t = "SUB BAGIAN UMUM DAN KEPEGAWAIAN";

      $j3 = 1406; // "KEPALA BIDANG PEMBINAAN PAUD DAN PENDIDIKAN NON FORMAL";
      $j3t = "BIDANG PEMBINAAN PAUD DAN PENDIDIKAN NON FORMAL";
      $j31 = 1407; // "KEPALA SEKSI KURIKULUM";
      $j31t = "SEKSI KURIKULUM PNF";
      $j32 = 1408; // "KEPALA SEKSI PESERTA DIDIK";
      $j32t = "SEKSI PESERTA DIDIK PNF";
      $j33 = 1409; // "KEPALA SEKSI KELEMBAGAAN DAN SARANA PRASARANA";
      $j33t = "SEKSI KELEMBAGAAN DAN SARANA PRASARANA PNF";

      $j4 = 1410; // "KEPALA BIDANG PEMBINAAN SD";
      $j4t = "BIDANG PEMBINAAN SD";
      $j41 = 1411; // "KEPALA SEKSI KURIKULUM";
      $j41t = "SEKSI KURIKULUM SD";
      $j42 = 1412; // "KEPALA SEKSI PESERTA DIDIK";
      $j42t = "SEKSI PESERTA DIDIK SD";
      $j43 = 1413; // "KEPALA SEKSI KELEMBAGAAN DAN SARANA PRASARANA";
      $j43t = "SEKSI KELEMBAGAAN DAN SARANA PRASARANA SD";

      $j5 = 1414; // "KEPALA BIDANG PEMBINAAN SMP";
      $j5t = "BIDANG PEMBINAAN SMP";
      $j51 = 1415; // "KEPALA SEKSI KURIKULUM";
      $j51t = "SEKSI KURIKULUM SMP";
      $j52 = 1416; // "KEPALA SEKSI PESERTA DIDIK";
      $j52t = "SEKSI PESERTA DIDIK SMP";
      $j53 = 1417; // "KEPALA SEKSI KELEMBAGAAN DAN SARANA PRASARANA";
      $j53t = "SEKSI KELEMBAGAAN DAN SARANA PRASARANA SMP";

      $j6 = 1418; // "KEPALA BIDANG PEMBINAAN KETENAGAAN";
      $j6t = "BIDANG PEMBINAAN KETENAGAAN";
      $j61 = 1419; // "KEPALA SEKSI KETENAGAAN PAUD DAN PENDIDIKAN NON FORMAL";
      $j61t = "SEKSI KETENAGAAN PAUD DAN PENDIDIKAN NON FORMAL";
      $j62 = 1420; // "KEPALA SEKSI KETENAGAAN PENDIDIKAN DASAR";
      $j62t = "SEKSI KETENAGAAN PENDIDIKAN DASAR";
      $j63 = 1421; // "KEPALA SEKSI KETENAGAAN KEBUDAYAAN";
      $j63t = "SEKSI KETENAGAAN KEBUDAYAAN";

      $j7 = 1422; // "KEPALA BIDANG PEMBINAAN KEBUDAYAAN";
      $j7t = "BIDANG PEMBINAAN KEBUDAYAAN";
      $j71 = 1423; // "KEPALA SEKSI CAGAR BUDAYA DAN MUSEUM";
      $j71t = "SEKSI CAGAR BUDAYA DAN MUSEUM";
      $j72 = 1424; // "KEPALA SEKSI SEJARAH DAN TRADISI";
      $j72t = "SEKSI SEJARAH DAN TRADISI";
      $j73 = 1425; // "KEPALA SEKSI KESENIAN";
      $j73t = "SEKSI KESENIAN";
      ...
      $this->setFont('arial','',8);
      $this->MULTICELL(4,0.333,$j3t.$j3plt,1,'C',0);
      $this->setFont('arial','',8);
      ...
      if ($j31plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,1,$j31t.$j31plt,1,'C',1);
      }else {
      $this->MULTICELL(4,1,$j31t.$j31plt,1,'C',0);
      }
      $this->setFont('arial','',8);
      $this->setXY(3.5,14);
      ...
      if ($j32plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,1,$j32t.$j32plt,1,'C',1);
      }else {
      $this->MULTICELL(4,1,$j32t.$j32plt,1,'C',0);
      }
      $this->setFont('arial','',9);
      ...
      if ($j33plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.5,$j33t.$j33plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.5,$j33t.$j33plt,1,'C',0);
      }
      $this->setFont('arial','',8);
      $this->setXY(3.5,18.5);
      ...
      $this->setXY(10,10.25);
      $this->setFont('arial','',8);
      $this->MULTICELL(4,1,$j4t.$j4plt,1,'C',0);
      $this->setFont('arial','',7);
      $this->setXY(10,11.25);
      ...
      if ($j41plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,1,$j41t.$j41plt,1,'C',1);
      }else {
      $this->MULTICELL(4,1,$j41t.$j41plt,1,'C',0);
      }
      $this->setFont('arial','',6);
      $this->setXY(10,14);
      $this->MULTICELL(4,0.5,$j41nama,'LRT','C',0);
      $this->setXY(10,14.5);
      ...
      if ($j42plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,1,$j42t.$j42plt,1,'C',1);
      }else {
      $this->MULTICELL(4,1,$j42t.$j42plt,1,'C',0);
      }
      $this->setFont('arial','',8);
      $this->setXY(10,16.25);
      ...
      if ($j43plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.5,$j43t.$j43plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.5,$j43t.$j43plt,1,'C',0);
      }
      $this->setFont('arial','',7);
      $this->setXY(10,18.5);
      ...
      $this->setFont('arial','',8);
      $this->MULTICELL(4,1,$j5t.$j5plt,1,'C',0);
      $this->setFont('arial','',9);
      ...
      if ($j51plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,1,$j51t.$j51plt,1,'C',1);
      }else {
      $this->MULTICELL(4,1,$j51t.$j51plt,1,'C',0);
      }
      $this->setFont('arial','',7);
      $this->setXY(17.5,14);
      ...
      if ($j52plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,1,$j52t.$j52plt,1,'C',1);
      }else {
      $this->MULTICELL(4,1,$j52t.$j52plt,1,'C',0);
      }
      $this->setFont('arial','',8);
      ...
      if ($j61plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.333,$j61t.$j61plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.333,$j61t.$j61plt,1,'C',0);
      }
      $this->setFont('arial','',8);
      $this->setXY(24,14);
      ...
      if ($j62plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.5,$j62t.$j62plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.5,$j62t.$j62plt,1,'C',0);
      }
      $this->setFont('arial','',8);
      $this->setXY(24,16.25);
      ...
      if ($j63plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.5,$j63t.$j63plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.5,$j63t.$j63plt,1,'C',0);
      }
      $this->setFont('arial','',7);
      $this->setXY(24,18.5);
      $this->MULTICELL(4,0.334,$j63nama,'LRT','C',0);
      $this->setXY(24,19);
      ...
      if ($j73plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,1,$j73t.$j73plt,1,'C',1);
      }else {
      $this->MULTICELL(4,1,$j73t.$j73plt,1,'C',0);
      }
      $this->setFont('arial','',7);
