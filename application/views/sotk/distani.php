...
{     
  ...
  function Content($data)
  {
      ...
      $j3 = "KEPALA BIDANG TANAMAN PANGAN";
      $j3t = "BIDANG TANAMAN PANGAN";
      $j31 = "KEPALA SEKSI PRODUKSI TANAMAN PANGAN";
      $j31t = "SEKSI PRODUKSI TANAMAN PANGAN";
      $j32 = "KEPALA SEKSI PERBENIHAN DAN PERLINDUNGAN TANAMAN PANGAN";
      $j32t = "SEKSI PERBENIHAN DAN PERLINDUNGAN TANAMAN PANGAN";
      $j33 = "KEPALA SEKSI PENGOLAHAN DAN PEMASARAN HASIL TANAMAN PANGAN";
      $j33t = "SEKSI PENGOLAHAN DAN PEMASARAN HASIL TANAMAN PANGAN";

      $j4 = "KEPALA BIDANG HORTIKULTURA";
      $j4t = "BIDANG HORTIKULTURA";
      $j41 = "KEPALA SEKSI PRODUKSI HORTIKULTURA";
      $j41t = "SEKSI PRODUKSI HORTIKULTURA";
      $j42 = "KEPALA SEKSI PERBENIHAN DAN PERLINDUNGAN HORTIKULTURA";
      $j42t = "SEKSI PERBENIHAN DAN PERLINDUNGAN HORTIKULTURA";
      $j43 = "KEPALA SEKSI PENGOLAHAN DAN PEMASARAN HASIL HORTIKULTURA";
      $j43t = "SEKSI PENGOLAHAN DAN PEMASARAN HASIL HORTIKULTURA";

      $j5 = "KEPALA BIDANG PETERNAKAN";
      $j5t = "BIDANG PETERNAKAN";
      $j51 = "KEPALA SEKSI PRODUKSI, PENYEBARAN DAN PENGEMBANGAN PETERNAKAN";
      $j51t = "SEKSI PRODUKSI, PENYEBARAN DAN PENGEMBANGAN PETERNAKAN";
      $j52 = "KEPALA SEKSI KESEHATAN HEWAN DAN KESEHATAN MASYARAKAT VETERINER";
      $j52t = "SEKSI KESEHATAN HEWAN DAN KESEHATAN MASYARAKAT VETERINER";
      $j53 = "KEPALA SEKSI PENGOLAHAN DAN PEMASARAN HASIL PETERNAKAN";
      $j53t = "SEKSI PENGOLAHAN DAN PEMASARAN HASIL PETERNAKAN";

      $j6 = "KEPALA BIDANG PERKEBUNAN";
      $j6t = "BIDANG PERKEBUNAN";
      $j61 = "KEPALA SEKSI PRODUKSI PERKEBUNAN";
      $j61t = "SEKSI PRODUKSI PERKEBUNAN";
      $j62 = "KEPALA SEKSI PERBENIHAN DAN PERLINDUNGAN PERKEBUNAN";
      $j62t = "SEKSI PERBENIHAN DAN PERLINDUNGAN PERKEBUNAN";
      $j63 = "KEPALA SEKSI PENGOLAHAN DAN PEMASARAN HASIL PERKEBUNAN";
      $j63t = "SEKSI PENGOLAHAN DAN PEMASARAN HASIL PERKEBUNAN";

      $j7 = "KEPALA BIDANG PRASARANA, SARANA DAN PENYULUHAN";
      $j7t = "BIDANG PRASARANA, SARANA DAN PENYULUHAN";
      $j71 = "KEPALA SEKSI LAHAN, IRIGASI DAN PEMBIAYAAN";
      $j71t = "SEKSI LAHAN, IRIGASI DAN PEMBIAYAAN";
      $j72 = "KEPALA SEKSI PUPUK, PESTISIDA, ALAT DAN MESIN";
      $j72t = "SEKSI PUPUK, PESTISIDA, ALAT DAN MESIN";
      $j73 = "KEPALA SEKSI KELEMBAGAAN DAN SARANA PENYULUHAN";
      $j73t = "SEKSI KELEMBAGAAN DAN SARANA PENYULUHAN";
      ...
      if ($j32plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.333,$j32t.$j32plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.333,$j32t.$j32plt,1,'C',0);
      }
      $this->setFont('arial','',7);
      $this->setXY(3.5,16.25);
      $this->MULTICELL(4,0.334,$j32nama,'LRT','C',0);
      $this->setFont('arial','',8);
      ...
      if ($j42plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.333,$j42t.$j42plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.333,$j42t.$j42plt,1,'C',0);
      }
      $this->setFont('arial','',7);
      $this->setXY(10,16.25);
      ...
      if ($j51plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.333,$j51t.$j51plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.333,$j51t.$j51plt,1,'C',0);
      }
      $this->setFont('arial','',7);
      $this->setXY(17.5,14);
      ...
      if ($j52plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.333,$j52t.$j52plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.333,$j52t.$j52plt,1,'C',0);
      }
      $this->setFont('arial','',7);
      ...
      if ($j53plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.333,$j53t.$j53plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.333,$j53t.$j53plt,1,'C',0);
      }
      $this->setFont('arial','',9);
      ...
      $this->setXY(24,10.25);
      $this->setFont('arial','',8);
      $this->MULTICELL(4,1,$j6t.$j6plt,1,'C',0);
      $this->setFont('arial','',8);
      $this->setXY(24,11.25);
      ...
      $this->setFont('arial','',8);
      $this->MULTICELL(4,0.333,$j7t.$j7plt,1,'C',0);
      $this->setFont('arial','',7);
      $this->setXY(30.5,11.25);
      $this->MULTICELL(4,0.334,$j7nama,'LRT','C',0);
      ...
      $this->setFont('arial','',7);
      $this->setXY(30.5,14);
      $this->MULTICELL(4,0.333,$j71nama,'LRT','C',0);
      $this->setFont('arial','',8);
      ...
      if ($j73plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.5,$j73t.$j73plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.5,$j73t.$j73plt,1,'C',0);
      }
      $this->setFont('arial','',8);
