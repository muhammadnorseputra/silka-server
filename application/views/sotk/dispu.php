...
{     
  ...
  {
      $unker = "DINAS PEKERJAAN UMUM DAN PENATAAN RUANG";
      $j1 = "KEPALA";
      $j1t = "DINAS PEKERJAAN UMUM DAN PENATAAN RUANG";
      ...
      $j3 = "KEPALA BIDANG BINA MARGA";
      $j3t = "BIDANG BINA MARGA";
      $j31 = "KEPALA SEKSI PEMBANGUNAN JALAN DAN JEMBATAN";
      $j31t = "SEKSI PEMBANGUNAN JALAN DAN JEMBATAN";
      $j32 = "KEPALA SEKSI BINA TEKNIK KEBINAMARGAAN";
      $j32t = "SEKSI BINA TEKNIK KEBINAMARGAAN";
      $j33 = "KEPALA SEKSI PEMELIHARAAN DAN PENINGKATAN JALAN DAN JEMBATAN";
      $j33t = "SEKSI PEMELIHARAAN DAN PENINGKATAN JALAN DAN JEMBATAN";

      $j4 = "KEPALA BIDANG CIPTA KARYA";
      $j4t = "BIDANG CIPTA KARYA";
      $j41 = "KEPALA SEKSI PEMBANGUNAN GEDUNG";
      $j41t = "SEKSI PEMBANGUNAN GEDUNG";
      $j42 = "KEPALA SEKSI BINA TEKNIK KECIPTAKARYAAN";
      $j42t = "KASI BINA TEKNIK KECIPTAKARYAAN";
      $j43 = "KEPALA SEKSI SARANA PRASARANA PENYEHATAN LINGKUNGAN";
      $j43t = "SEKSI SARANA PRASARANA PENYEHATAN LINGKUNGAN";

      $j5 = "KEPALA BIDANG JASA KONSTRUKSI DAN PERALATAN";
      $j5t = "BIDANG JASA KONSTRUKSI DAN PERALATAN";
      $j51 = "KEPALA SEKSI PENGATURAN DAN PENGAWASAN JASA KONSTRUKSI";
      $j51t = "SEKSI PENGATURAN DAN PENGAWASAN JASA KONSTRUKSI";
      $j52 = "KEPALA SEKSI PEMBERDAYAAN JASA KONSTRUKSI";
      $j52t = "SEKSI PEMBERDAYAAN JASA KONSTRUKSI";
      $j53 = "KEPALA SEKSI PERALATAN";
      $j53t = "SEKSI PERALATAN";

      $j6 = "KEPALA BIDANG SUMBER DAYA AIR";
      $j6t = "BIDANG SUMBER DAYA AIR";
      $j61 = "KEPALA SEKSI BINA TEKNIK SUMBER DAYA AIR";
      $j61t = "SEKSI BINA TEKNIK SUMBER DAYA AIR";
      $j62 = "KEPALA SEKSI PEMELIHARAAN IRIGASI, RAWA DAN SUNGAI";
      $j62t = "SEKSI PEMELIHARAAN IRIGASI, RAWA DAN SUNGAI";
      $j63 = "KEPALA SEKSI PENINGKATAN DAN PEMBANGUNAN IRIGASI, RAWA DAN SUNGAI";
      $j63t = "SEKSI PENINGKATAN DAN PEMBANGUNAN IRIGASI, RAWA DAN SUNGAI";

      $j7 = "KEPALA BIDANG PENATAAN RUANG";
      $j7t = "BIDANG PENATAAN RUANG";
      $j71 = "KEPALA SEKSI PERENCANAAN RUANG";
      $j71t = "SEKSI PERENCANAAN RUANG";
      $j72 = "KEPALA SEKSI PEMANFAATAN RUANG";
      $j72t = "SEKSI PEMANFAATAN RUANG";
      $j73 = "KEPALA SEKSI PENGAWASAN DAN PENGENDALIAN RUANG";
      $j73t = "SEKSI PENGAWASAN DAN PENGENDALIAN RUANG";
      ...
      $this->MULTICELL(4,0.333,$j32nama,'LRT','C',0);
      $this->setFont('arial','',8);
      ...
      $this->setFont('arial','',7);
      $this->setXY(10,11.25);
      $this->MULTICELL(4,0.334,$j4nama,'LRT','C',0);
      $this->setXY(10,11.75);
      ...
      if ($j51plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,0.334,$j51t.$j51plt,1,'C',1);
      }else {
      $this->MULTICELL(4,0.334,$j51t.$j51plt,1,'C',0);
      }
      $this->setFont('arial','',7);
      $this->setXY(17.5,14);
      ...
      if ($j53plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(4,1,$j53t.$j53plt,1,'C',1);
      }else {
      $this->MULTICELL(4,1,$j53t.$j53plt,1,'C',0);
      }
      $this->setFont('arial','',7);
