...
{     
  ...
  function Content($data)
  {
      ...
      $j3 = "KEPALA BIDANG PERLINDUNGAN DAN JAMINAN SOSIAL";
      $j3t = "BIDANG PERLINDUNGAN DAN JAMINAN SOSIAL";
      $j31 = "KEPALA SEKSI PERLINDUNGAN SOSIAL KORBAN BENCANA ALAM";
      $j31t = "SEKSI PERLINDUNGAN SOSIAL KORBAN BENCANA ALAM";
      $j32 = "KEPALA SEKSI PERLINDUNGAN SOSIAL KORBAN BENCANA SOSIAL";
      $j32t = "SEKSI PERLINDUNGAN SOSIAL KORBAN BENCANA SOSIAL";
      $j33 = "KEPALA SEKSI JAMINAN SOSIAL KELUARGA";
      $j33t = "SEKSI JAMINAN SOSIAL KELUARGA";

      $j4 = "KEPALA BIDANG REHABILITASI SOSIAL";
      $j4t = "BIDANG REHABILITASI SOSIAL";
      $j41 = "KEPALA SEKSI REHABILITASI SOSIAL ANAK";
      $j41t = "SEKSI REHABILITASI SOSIAL ANAK";
      $j42 = "KEPALA SEKSI REHABILITASI SOSIAL PENYANDANG DISABILITAS DAN LANSIA";
      $j42t = "SEKSI REHABILITASI SOSIAL PENYANDANG DISABILITAS DAN LANSIA";
      $j43 = "KEPALA SEKSI REHABILITASI SOSIAL PENYALAHGUNAAN NAPZA DAN TUNA SOSIAL";
      $j43t = "SEKSI REHABILITASI SOSIAL PENYALAHGUNAAN NAPZA DAN TUNA SOSIAL";

      $j5 = "KEPALA BIDANG PEMBERDAYAAN SOSIAL";
      $j5t = "BIDANG PEMBERDAYAAN SOSIAL";
      $j51 = "KEPALA SEKSI PEMBERDAYAAN SOSIAL PERORANGAN, KELUARGA DAN KELEMBAGAAN MASYARAKAT";
      $j51t = "SEKSI PEMBERDAYAAN SOSIAL PERORANGAN, KELUARGA DAN KELEMBAGAAN MASYARAKAT";
      $j52 = "KEPALA SEKSI PEMBERDAYAAN KOMUNITAS ADAT TERPENCIL";
      $j52t = "SEKSI PEMBERDAYAAN KOMUNITAS ADAT TERPENCIL";
      $j53 = "KEPALA SEKSI KEPAHLAWANAN, KEPERINTISAN, KESETIAKAWANAN, RESTORASI SOSIAL DAN PENGELOLAAN SUMBER DAYA SOSIAL";
      $j53t = "SEKSI KEPAHLAWANAN, KEPERINTISAN, KESETIAKAWANAN, RESTORASI SOSIAL DAN PENGELOLAAN SUMBER DAYA SOSIAL";

      $j6 = "KEPALA BIDANG PENANGANAN FAKIR MISKIN";
      $j6t = "BIDANG PENANGANAN FAKIR MISKIN";
      $j61 = "KEPALA SEKSI PENANGANAN FAKIR MISKIN PERDESAAN";
      $j61t = "SEKSI PENANGANAN FAKIR MISKIN PERDESAAN";
      $j62 = "KEPALA SEKSI PENANGANAN FAKIR MISKIN PERKOTAAN";
      $j62t = "SEKSI PENANGANAN FAKIR MISKIN PERKOTAAN";
      $j63 = "KEPALA SEKSI PENANGANAN FAKIR MISKIN DESA TERPENCIL";
      $j63t = "SEKSI PENANGANAN FAKIR MISKIN DESA TERPENCIL";
      ...
      if ($j42plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(5.5,0.333,$j42t.$j42plt,1,'C',1);
      }else {
      $this->MULTICELL(5.5,0.333,$j42t.$j42plt,1,'C',0);
      }
      $this->setFont('arial','',9);
      $this->setXY(12,16.25);
      ...
      if ($j53plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(5.5,0.333,$j53t.$j53plt,1,'C',1);
      }else {
      $this->MULTICELL(5.5,0.333,$j53t.$j53plt,1,'C',0);
      }
      $this->setFont('arial','',8);
...
$pdf->AddPage();
$pdf->Content($data);
//$this->Output('nominatif per unker', 'D');
$pdf->Output();
