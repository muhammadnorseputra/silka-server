...
{     
  ...
  {
      $unker = "KECAMATAN PARINGIN SELATAN";
      $j1 = "CAMAT";
      $j1t = "KECAMATAN PARINGIN SELATAN";
      ...
      $this->setFont('arial','',7);
      $this->setXY(20,10.5);
      $this->MULTICELL(3.5,0.334,$j21nama,'LRT','C',0);
	$this->setXY(20,11);
      $this->setFont('arial','',8);
      ...
      $this->MULTICELL(4,0.333,$j3nama,'LRT','C',0);
      ...
      $this->MULTICELL(4,0.333,$j5nama,'LRT','C',0);
...
$pdf->AddPage();
$pdf->Content($data);
$pdf->Output('sotk camat_parsel.pdf', 'I');
