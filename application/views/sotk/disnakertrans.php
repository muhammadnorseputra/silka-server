...
{     
  ...
  {
      $unker = "DINAS TENAGA KERJA DAN TRANSMIGRASI";
      $j1 = "KEPALA";
      $j1t = "DINAS TENAGA KERJA DAN TRANSMIGRASI";
      ...
      $j3 = "KEPALA BIDANG PELATIHAN KERJA DAN PENEMPATAN TENAGA KERJA";
      $j3t = "BIDANG PELATIHAN KERJA DAN PENEMPATAN TENAGA KERJA";
      $j31 = "KEPALA SEKSI PELATIHAN DAN PRODUKTIVITAS";
      $j31t = "SEKSI PELATIHAN DAN PRODUKTIVITAS";
      $j32 = "KEPALA SEKSI PENEMPATAN TENAGA KERJA DAN PERLUASAN KESEMPATAN KERJA";
      $j32t = "SEKSI PENEMPATAN TENAGA KERJA DAN PERLUASAN KESEMPATAN KERJA";

      $j4 = "KEPALA BIDANG HUBUNGAN INDUSTRIAL";
      $j4t = "BIDANG HUBUNGAN INDUSTRIAL";
      $j41 = "KEPALA SEKSI PERSYARATAN KERJA";
      $j41t = "SEKSI PERSYARATAN KERJA";
      $j42 = "KEPALA SEKSI PENYELESAIAN PERSELISIHAN HUBUNGAN INDUSTRIAL";
      $j42t = "SEKSI PENYELESAIAN PERSELISIHAN HUBUNGAN INDUSTRIAL";

      $j6 = "KEPALA BIDANG PEMBERDAYAAN MASYARAKAT TRANSMIGRASI";
      $j6t = "BIDANG PEMBERDAYAAN MASYARAKAT TRANSMIGRASI";
      $j61 = "KEPALA SEKSI PENGEMBANGAN USAHA MASYARAKAT DAN SDM TRANSMIGRAN";
      $j61t = "SEKSI PENGEMBANGAN USAHA MASYARAKAT DAN SDM TRANSMIGRAN";
      $j62 = "KEPALA SEKSI BINA SARANA DAN PRASARANA LINGKUNGAN TRANSMIGRASI";
      $j62t = "SEKSI BINA SARANA DAN PRASARANA LINGKUNGAN TRANSMIGRASI";
      ...
      if ($j61plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(5.5,0.333,$j61t.$j61plt,1,'C',1);
      }else {
      $this->MULTICELL(5.5,0.333,$j61t.$j61plt,1,'C',0);
      }
      $this->setFont('arial','',8);
      $this->setXY(29,14);
      ...
      $this->setFont('arial','',8);
      $this->setXY(29,16.25);
      $this->MULTICELL(5.5,0.34,$j62nama,'LRT','C',0);
      $this->setXY(29,16.75);
...
$pdf->AddPage();
$pdf->Content($data);
$pdf->Output('sotk disnakertrans.pdf', 'I');
