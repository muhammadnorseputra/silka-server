...
{     
  ...
  function Content($data)
  {
      ...
      $j3 = "KEPALA BIDANG PEMBINAAN KEARSIPAN";
      $j3t = "BIDANG PEMBINAAN KEARSIPAN";
      $j31 = "KEPALA SEKSI PEMBINAAN KEARSIPAN PERANGKAT DAERAH";
      $j31t = "SEKSI PEMBINAAN KEARSIPAN PERANGKAT DAERAH";
      $j32 = "KEPALA SEKSI PEMBINAAN KEARSIPAN PERUSAHAAN, ORGANISASI KEMASYARAKATAN/ORGANISASI POLITIK DAN DESA/KELURAHAN";
      $j32t = "SEKSI PEMBINAAN KEARSIPAN PERUSAHAAN, ORGANISASI KEMASYARAKATAN/ORGANISASI POLITIK DAN DESA/KELURAHAN";
      // BARU 19 DESEMBER 2019
      $j33 = "KEPALA SEKSI PEMBINAAN SUMBER DAYA MANUSIA KEARSIPAN";
      $j33t = "SEKSI PEMBINAAN SUMBER DAYA MANUSIA KEARSIPAN";

      $j4 = "KEPALA BIDANG PENGAWASAN KEARSIPAN";
      $j4t = "BIDANG PENGAWASAN KEARSIPAN";
      $j41 = "KEPALA SEKSI PENGAWASAN KEARSIPAN PERANGKAT DAERAH";
      $j41t = "SEKSI PENGAWASAN KEARSIPAN PERANGKAT DAERAH";
      $j42 = "KEPALA SEKSI PENGAWASAN KEARSIPAN PERUSAHAAN, ORGANISASI KEMASYARAKATAN/ORGANISASI POLITIK DAN DESA/KELURAHAN";
      $j42t = "SEKSI PENGAWASAN KEARSIPAN PERUSAHAAN, ORGANISASI KEMASYARAKATAN/ORGANISASI POLITIK DAN DESA/KELURAHAN";

      $j6 = "KEPALA BIDANG PENGELOLAAN ARSIP";
      $j6t = "BIDANG PENGELOLAAN ARSIP";
      $j61 = "KEPALA SEKSI PENGELOLAAN ARSIP DINAMIS";
      $j61t = "SEKSI PENGELOLAAN ARSIP DINAMIS";
      $j62 = "KEPALA SEKSI AKUISISI, PENGELOLAAN DAN PRESERVASI ARSIP";
      $j62t = "SEKSI AKUISISI, PENGELOLAAN DAN PRESERVASI ARSIP";
      // BARU 19 DESEMBER 2019
      $j63 = "KEPALA SEKSI LAYANAN DAN PEMANFAATAN ARSIP STATIS";
      $j63t = "SEKSI LAYANAN DAN PEMANFAATAN ARSIP STATIS";
      ...
      if ($j32plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(5.5,0.25,$j32t.$j32plt,1,'C',1);
      }else {
      $this->MULTICELL(5.5,0.25,$j32t.$j32plt,1,'C',0);
      }
      $this->setFont('arial','',8);
      ...
      if ($j33plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(5.5,0.5,$j33t.$j33plt,1,'C',1);
      }else {
      $this->MULTICELL(5.5,0.5,$j33t.$j33plt,1,'C',0);
      }
      $this->setFont('arial','',8);
      $this->setXY(3.5,18.5);
      ...
      if ($j42plt) {
        $this->setFillColor($pltcl);
        $this->MULTICELL(5.5,0.25,$j42t.$j42plt,1,'C',1);
      }else {
      $this->MULTICELL(5.5,0.25,$j42t.$j42plt,1,'C',0);
      }
      $this->setFont('arial','',8);
      $this->setXY(12,16.25);
      ...
      $this->setXY(29,10.25);
      $this->setFont('arial','',8);
      $this->MULTICELL(5.5,1,$j6t.$j6plt,1,'C',0);
      $this->setFont('arial','',8);
      $this->setXY(29,11.25);
      ...
      $this->Line(1.75,12.5,1.75,18.5); // Garis tegak panjang pada bidang 1
      $this->Line(5.5,12.25,5.5,12.5); // Garis tegak antara bidang dgn seksi (pendek)
      $this->Line(1.75,12.5,5.5,12.5); // Garis datar panjang antara bidang dgn seksi
      $this->Line(1.75,14,2,14); // Garis datar pendek antara bidang dgn seksi 1
      $this->Line(1.75,16.25,2,16.25); // Garis datar pendek antara bidang dgn seksi 2
      $this->Line(1.75,18.5,2,18.5); // Garis datar pendek pendek antara bidang dgn seksi 3
      ...
      $this->Line(31,12.25,31,12.5); // Garis tegak antara bidang dgn seksi (pendek)
      $this->Line(27.25,12.5,31,12.5); // Garis datar antara bidang dgn seksi
      $this->Line(27.25,14,27.5,14); // Garis datar pendek antara bidang dgn seksi 1
      $this->Line(27.25,16.25,27.5,16.25); // Garis datar pendek antara bidang dgn seksi 2
      $this->Line(27.25,18.5,27.5,18.5); // Garis datar pendek antara bidang dgn seksi 3
...
$pdf->AddPage();
$pdf->Content($data);
$pdf->Output('sotk disarsip.pdf', 'I');
