...
{     
  ...
  function Content($data)
  {
      ...
      $unker = "DINAS PENDIDIKAN DAN KEBUDAYAAN";
      $j1 = "KEPALA DINAS PENDIDIKAN DAN KEBUDAYAAN";
      $j1t = "DINAS PENDIDIKAN DAN KEBUDAYAAN";
	...
	*/
      ...
      $this->Image('assets/logo.jpg','1.5','1','1.5','2','jpg','');
      $this->setFont('courier','B',12);
      $this->text(3.5,1.3,'BAGAN STRUKTUR ORGANISASI');
      $this->text(3.5,1.8,$unker);
      $this->setFont('arial','B',8);
      $this->text(3.5,2.3,'Tgl. Cetak : '. date('d-m-Y'));
      $this->text(3.5,2.8,'SILKa Online ::: BKPSDM Kab. Balangan All rights reserved');
