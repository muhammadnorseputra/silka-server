...
<center>  
  <div class="panel panel-default" style="width: 60%">
    <div class="panel-body">
      ...
      <form method='POST' name='formeditdiktek' action='../pegawai/editdiktek_aksi'>
      ...
      <table class="table table-condensed">        
        <tr>
          ...
          <td><input type="text" name="namadiklat" size='80' maxlength='200' value='<?php echo $v['nama_diklat_teknis']; ?>' required /></td>
        </tr>
        <tr>
