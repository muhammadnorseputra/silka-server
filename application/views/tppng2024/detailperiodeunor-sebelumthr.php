  ...
  <table class='table table-condensed'>
    <tr>      
      ...
      <td align='right'>
        ...
        <span class="fa fa-pencil" aria-hidden="true"></span> Update Status</button>
      </td>
      <?php
        }
      ?>
	...
	//if (($statuspengantar == "SKPD") AND (($this->session->userdata('nip') == "198104072009041002") OR ($this->session->userdata('nip') == "197708232006042022"))) {
	  ...
	  if (($tahunperiode == '2024') AND ($bulanperiode == '14') AND ($this->session->userdata('nip') == "198104072009041002")) { // Tambah Data THR
	    ?>
          	<button type="button" class="btn btn-outline btn-info" data-toggle="modal" data-target="#tampiltambahthr"><span class="fa fa-plus-square-o" aria-hidden="true"></span> Tambah Data TPP THR</button>
            <?php	
	  } else { 
            ?>
                <button type="button" class="btn btn-primary btn-outline" data-toggle="modal" data-target="#tampiltambah"><span class="fa fa-plus" aria-hidden="true"></span> Tambah Data</button>
            <?php
          }
	}
        ?>
	 ...
	 <!-- body modal-->
              <div class="modal-body" align="left"">
                <form method='POST' name='formkalkthr' style='padding-top:8px' action='../tppng2024/tmbkalkthr_aksi'>
                  ...
                  <div class='row'>
		    <div class='col-md-12'>
			<div class="alert alert-danger" role="alert"><strong>PERHATIAN !</strong> TPP THR Tahun 2024 berdasarkan status kedudukan dan posisi jabatan ASN (CUTLOSS) per 1 Maret 2024</div>
		    </div>
                    <div class='col-md-12'>
                      <div class="form-group input-group">
                        <span class="input-group-addon" style="font-size: 12px;">Unit Kerja</span>
