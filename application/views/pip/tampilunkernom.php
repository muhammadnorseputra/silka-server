...
<!-- Default panel contents -->
  ...
  <div class="panel panel-success" style="padding:3px;overflow:auto;width:100%;height:610px;">
        ...
        <b>NOMINATIF INDEKS PROFESIONALITAS ASN</b>
        </div>
  
  <table class='table table-condensed'>
    <tr>            
      <td align='right'>
        <form method="POST" action="../pip/tampilrekappip2019">
          <button type="submit" class="btn btn-sm">
            <span class="glyphicon glyphicon-tasks" aria-hidden="true"></span> Rekapitulasi 2019
          </button>
        </form>
      </td>
      <td align='right' width='30'>
        <form method="POST" action="../pip/tampilrekappip2020">
          <button type="submit" class="btn btn-info btn-sm">
            <span class="glyphicon glyphicon-tasks" aria-hidden="true"></span> Rekapitulasi 2020
          </button>
        </form>
      </td>
      <td align='right' width='30'>
        <form method="POST" action="../pip/tampilrekappip2021">
          <button type="submit" class="btn btn-success btn-sm">
            <span class="glyphicon glyphicon-tasks" aria-hidden="true"></span> Rekapitulasi 2021
          </button>
        </form>
      </td>
      <td align='right' width='30'>
    ...
    <form method='POST' name='formupdatestatus'>    
      ...
      <tr>        
        ...
        <td>
          ...
          <?php
          echo "<option value=''>- Pilih Tahun Pengukuran -</option>";
          foreach($tahun as $thn)
          {
            echo "<option value='".$thn['tahun']."' selected>".$thn['tahun']."</option>";
          }
          ?>
          </select>    
        </td>
