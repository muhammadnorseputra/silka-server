        ...
        <div class="col-lg-6">
            <div class="panel panel-success">
                ...
                <div class="panel-footer">
                  ...
                  ?>
                  <span class="pull-left"><b><?php echo $persen." % dari Total PNS"; ?></b></span>
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            ...
                            <div><b><?php echo "IP ASN TAHUN 2019"?></b></div>
                        </div>
                    </div>
                </div>
                <div class="panel-footer">
          ...
          <div class="tab-pane face in active" id="rekap">
            ...
            echo "<br />
              ...
              <tr class='danger'>
                ...
                <td align='center' width='600'><b>Nama Unit Kerja<br/><code>SKOR INDEKS PROFESIONALISME</code></b></td>
