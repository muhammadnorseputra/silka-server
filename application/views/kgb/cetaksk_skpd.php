...
{     
	...
	{        
		...
		$this->setFont('Arial','B',20);
            ...
            $this->setXY(120,$y+25);
            $this->cell(60,5,"KEPALA BADAN KEUANGAN DAERAH",0,1,'L',1); 
            $this->setXY(120,$y+30);
            ...
            $this->setXY(110,$y+80); $this->cell(3,5,": ",0,1,'L',1);
	    $this->setFont('Arial','',9);            
            $this->setXY(113,$y+80); $this->cell(80,5,$opeg->mpegawai->getnamapangkat($key->fid_golru_skr)." (".$opeg->mpegawai->getnamagolru($key->fid_golru_skr).")",0,1,'L',1);
            ...
            $this->setFont('Arial','',9);
            $this->setXY(113,$y+85);
	    $this->MULTICELL(80,5,strtoupper($opeg->mpegawai->namajab($key->fid_jnsjab, $idjab)),'','L',1); 
            ...
            $this->setFont('Arial','',11);
            $this->setXY(50,$y+90); 
	    $this->cell(55,5,"4. Unit Kerja",0,1,'L',1); 
            $this->setXY(110,$y+90);
	    $this->cell(3,5,": ",0,1,'L',1);            
            $this->setFont('Arial','',10);
            $this->setXY(113,$y+90); 
	    $this->MULTICELL(90,5,$ounker->munker->getnamaunker($key->fid_unit_kerja),'','L',1); 
            ...
            $this->setFont('Arial','',11);
            $this->setXY(50,$y+90); $this->cell(55,5,"5. Gaji Pokok Lama",0,1,'L',1); 
            $this->setXY(110,$y+90); $this->cell(3,5,": ",0,1,'L',1);            
            $this->setXY(113,$y+90); $this->cell(80,5,"Rp. ".indorupiah($key->gapok_lama).",-",0,1,'L',1);
            ...
            $this->setXY(50,$y+180);
            $this->MULTICELL(140,5,"Di harap agar sesuai dengan Peraturan Pemerintah Nomor 30 Tahun 2015 kepada Pegawai Negeri Sipil tersebut dapat dibayarkan penghasilannya berdasarkan gaji pokok yang baru.",'','J',1); 
	    ...
	    // tanda tangan
            $this->Image('assets/ttd_kaban1.jpg', 105, 250,'86','53','jpeg');            
	    ...
	    $this->setXY(110,$y+200);
			...
			$this->cell(70,5,'Drs. H. ANSHARUDDIN, M.Si',0,1,'C',1);
                ...
                $this->setFont('Arial','U',11);
                $this->setXY(110,$y+240); $this->cell(70,5,'Ir. H. RUSKARIADI',0,1,'C',1); 
                $this->setFont('Arial','',11);
                $this->setXY(110,$y+245); $this->cell(70,5,'Pembina Utama Madya',0,1,'C',1); 
                $this->setXY(110,$y+250); $this->cell(70,5,'NIP. 19601001 198803 1 011',0,1,'C',1);                 
            } 

	    // Tampilkan QR Code dalam bentuk file png, ukuran 35 x 35
            $this->Image('assets/qrcodekgb/'.$key->qrcode.'.png', 50, 250,'30','30','png');
            ...
            if ($ounker->munker->getnamaunker($key->fid_unit_kerja) == 'INSPEKTORAT') {
                ...
                $jabatan = 'Kepala '.$ounker->munker->getnamaunker($key->fid_unit_kerja).' Kabupaten Balangan;';
            }

            //$this->setFont('Arial','U',9);
            //$this->setXY(20,$y+255); $this->cell(70,5,'Tembusan :',0,1,'L',1); 
            //$this->setFont('Arial','',9);            
            //$this->setXY(25,$y+260); $this->cell(70,5,'1. Kepala '.$ounker->munker->getnamaunker($key->fid_unit_kerja).' Kabupaten Balangan;',0,1,'L',1); 
            $this->setXY(25,$y+259); $this->cell(70,5,'1. '.$jabatan,0,1,'L',1); 
