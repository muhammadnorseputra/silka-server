...
<!-- Default panel contents -->
  ...
  <div class="panel panel-success"   style="padding:3px;overflow:auto;width:98%;height:510px;">
        <div class='panel-heading' align='left'><span class="glyphicon glyphicon-file" aria-hidden="true"></span>
        <b>REKAPUTILASI KGB</b>
        </div>
    ...
    <form method='POST' name='formupdatestatus'>    
      ...
      <tr>        
        ...
        <td>&nbspTahun Usul KGB :&nbsp
          ...
          <?php
          $tahunini = date(Y);
          echo "<option value='' selected>- Pilih Tahun Usul -</option>";
          echo "<option value='".($tahunini-2)."'>".($tahunini-2)."</option>";
          echo "<option value='".($tahunini-1)."'>".($tahunini-1)."</option>";
