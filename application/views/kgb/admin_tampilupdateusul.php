...
<!-- Default panel contents -->
  ...
  <div class="panel panel-info"   style="padding:3px;overflow:auto;width:70%;height:610px;">
        <div class='panel-heading' align='left'><span class="glyphicon glyphicon-file" aria-hidden="true"></span>
        <b>UPDATE DATA USUL KGB</b>
        </div>
    ...
    <form method='POST' name='formupdateusul'>    
      ...
      <tr>
        <td>
          ...
          <input type="text" name="nip" id="nip" class="form-control" placeholder="Ketik NIP dan tekan Enter" aria-describedby="basic-addon1" onkeyup="validAngka(this)" size='25' maxlength='18' onChange="showData(this.value)">
          </div>
        </td>        
      </tr>
      </table>
