...
*/
class Lhkpn extends REST_Controller  {
    ...
    public function index_get($nip=null)
    {
        ...
        $data = $this->rw->getRiwayatLhkpn($params);
        ...
        foreach($data->result() as $row) {
            $response[] = [
                "id" => $row->id,
                // "nip" => $row->nip,
                "tahun_wajib" => $row->tahun_wajib,
                "tgl_lapor" => $row->tgl_lapor,
                "tgl_penyampaian" => $row->tgl_penyampaian,
                "jenis_form" => $row->jenis_form,
                "status" => $row->status,
                "jabatan" => $row->jabatan,
                "unit_kerja" => $row->unit_kerja,
                "file_tbn" => $row->file_tbn,
        ...
        $result = [
            'kind' => 'Riwayat LHKPN',
            'status' => true,
            'message' => 'Riwayat LHKPN '.$params['nip'].' Ditemukan',
            'count' => $data->num_rows(),
