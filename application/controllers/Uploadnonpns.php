...
class Uploadnonpns extends CI_Controller {
  ...
  //var $offset=10;
    ...
    public function uploadphoto() {      
        ...
        $nmfile = $nik."-".$string.'.jpg'; //nama file nip + '-' + $id_golru (2 karakter) + nomor acak (19 karakter acak)
        ...
        {   
            if ($this->upload->do_upload('photo'))
            {
                ...
                $this->mnonpns->edit_nonpns($where, $dataphoto);
